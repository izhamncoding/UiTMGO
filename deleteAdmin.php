       ...
       <div class="fullborder">
                <div class="case">
                    ...
                    include("dbconn.php");
                        ...
                        $admin_id = $_REQUEST['anumber'];
                        
                        $sql01 = "SELECT * FROM admin_go WHERE admin_id= $admin_id";
                        ...
                        echo "Record is not existed";
                            ...
                            $sql2 = "DELETE FROM rider WHERE admin_id= $admin_id";
                            mysqli_query($dbconn, $sql2) or die ("Error: " . mysqli_error($dbconn));
                            
                            $sql3 = "DELETE FROM vendor WHERE admin_id= $admin_id";
                            mysqli_query($dbconn, $sql3) or die ("Error: " . mysqli_error($dbconn));
                            
                            $sql4 = "DELETE FROM admin_go WHERE admin_id= $admin_id";
                            mysqli_query($dbconn, $sql4) or die ("Error: " . mysqli_error($dbconn));
                            
                            echo "Data for admin has been deleted <br>";
