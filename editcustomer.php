...
<body>
   <section class="header">
       ...
       <div class="fullborder">
            <div class="case">
                <p style="font-size:25px; text-shadow: 2px 0 0 #000, 0 -1px 0 #000, 0 1px 0 #000, -1px 0 0 #000;">Customer List</p>
               <?php
                    include("dbconn.php");
                    ...
                    if($row == 0){
                        ...
                        echo"<td><a href='deleteCustomer.php?cnumber=".$row["customer_id"]."'>Delete</a></td>";
                        echo"</tr>";
                        }
                        echo"</table>";
                    }
           ...
           <div class="borderchocolate">
                <form name="form" method="post" action="customersearch.php">
                    <p>
                    Please Insert Customer ID To Proceed<br>
                    ID: <input type="text" name="customer_id" value=""><br>
