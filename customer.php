...
<body>
    <section class="header">
        ...
        <div class="box">
            <h2 style="margin-left: auto;margin-right: auto;display: block;width: 50%;text-align: center;font-size: 170%">Kedai Mek Kelate<br>Feature Menu</h2>
