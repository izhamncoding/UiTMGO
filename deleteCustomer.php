   ...
   <section class="header">
       ...
       <div class="fullborder">
                <div class="case">
                    ...
                    $customer_id = $_REQUEST['cnumber'];

                        $customer_id = $_REQUEST['cnumber'];
                        
                        $sql01 = "SELECT * FROM customer WHERE customer_id= $customer_id";
                        ...
                        echo "Record is not existed";
                            ...
                            $sql2 = "DELETE FROM order_detail WHERE customer_id= $customer_id";
                            mysqli_query($dbconn, $sql2) or die ("Error: " . mysqli_error($dbconn));
                            
                            $sql3 = "DELETE FROM payment WHERE customer_id= $customer_id";
                            mysqli_query($dbconn, $sql3) or die ("Error: " . mysqli_error($dbconn));
                            
                            $sql4 = "DELETE FROM orders WHERE customer_id= $customer_id";
                            mysqli_query($dbconn, $sql4) or die ("Error: " . mysqli_error($dbconn));
                            
                            $sql5 = "DELETE FROM customer WHERE customer_id= $customer_id";
                            mysqli_query($dbconn, $sql5) or die ("Error: " . mysqli_error($dbconn));
                            
                            
                            echo "Data for customer has been deleted <br>";
