                ...
                <div class="case">
                    <?php
                        ...
                        if(isset($_POST['Update'])){
                            ...
                            $rider_register = $_POST['rider_register'];
                            $rider_password = $_POST['rider_password'];
                            $sql0 = "SELECT rider_id FROM rider WHERE rider_id= $rider_id";
                            ...
                            $sql2 = "UPDATE rider SET rider_id = '" . $rider_id . "',
                            rider_name= '" . $rider_name . "',
                            rider_num = '" . $rider_num . "', rider_register = '" . $rider_register . "', rider_password = '" . $rider_password . "' where rider_id = '" . $id . "'";
                        ...
                        elseif(isset($_POST['Delete'])){
                            ...
                            $sql0 = "SELECT *  FROM rider WHERE rider_id= $rider_id";
                            ...
                            $sql2 = "DELETE FROM student WHERE rider_id= $rider_id";
