        ...
        <nav>
            ...
            <div class="nav-links">
                <ul>
                    ...
                    <li><a href="revenue%20statistic.htmlrevenuestatisticadmin.php"  >Revenue Statistic</a></li>
       ...
       <div class="fullborder">
                <div class="case">
                    ...
                    include("dbconn.php");
                        ...
                        $rider_id = $_REQUEST['rnumber'];
                        
                        $sql01 = "SELECT * FROM rider WHERE rider_id= $rider_id";
                        ...
                        echo "Record is not existed";
                            ...
                            $sql2 = "DELETE FROM salary WHERE rider_id= $rider_id";
                            mysqli_query($dbconn, $sql2) or die ("Error: " . mysqli_error($dbconn));
                            
                            $sql3 = "DELETE FROM orders WHERE rider_id= $rider_id";
                            mysqli_query($dbconn, $sql3) or die ("Error: " . mysqli_error($dbconn));
                            
                            $sql4 = "DELETE FROM order_detail WHERE rider_id= $rider_id";
                            mysqli_query($dbconn, $sql4) or die ("Error: " . mysqli_error($dbconn));
                            
                            $sql5 = "DELETE FROM rider WHERE rider_id= $rider_id";
                            mysqli_query($dbconn, $sql5) or die ("Error: " . mysqli_error($dbconn));

                            echo "Data for rider has been deleted <br>";
